...
import '/components/signupcompleted_widget.dart';
        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 70.0, 0.0, 17.0),
                  child: Container(
                    width: 200.0,
                    height: 10.11,
                    decoration: BoxDecoration(
                            ...
                            Align(
                              ...
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 8.0, 0.0, 24.0),
                                child: Text(
                                  'Create an account and bond the family together.',
                              ...
                              builder: (context) => Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    // Show verification message using EmailVerifyWidget
                                    showDialog(
                                      context: context,
                                    ...
                                    // Remove the immediate navigation to login
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  // Only show profile creation if user has no name
